...
app.config['MYSQL_USER'] = 'arP7SiueFC'
app.config['MYSQL_PASSWORD'] = 'ePPzKIqW0e'
app.config['MYSQL_DB'] = 'arP7SiueFC'
mysql = MySQL(app)
...
app.config['MAIL_USERNAME'] = 'aasdqw031@gmail.com'#put your eamil account
app.config['MAIL_PASSWORD'] = 'Mnblk_123' #put your email password
...
def sendmail():
    if request.method == 'POST':
        ...
        msg = Message('Hello', sender='aasdqw031@gmail.com',recipients=[rec])
